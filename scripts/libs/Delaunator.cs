...
namespace DelaunatorSharp
{
    ...
    public class Delaunator
    {
        ...
        private int HashKey(float x, float y) => Mathf.FloorToInt(PseudoAngle(x - cx, y - cy) * hashSize) % hashSize;
        ...
        public IEnumerable<Edge> GetEdgesOfTriangle(int t) => CreateHull(EdgesOfTriangle(t).Select(e => Points[Triangles[e]]));
