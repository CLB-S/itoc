...
public class RegistryEntryEventArgs<T> : EventArgs where T : class
{
    /// <summary>
    /// The registry
    /// </summary>
...
/// </summary>
/// <typeparam name="T">The type of content managed by the registry</typeparam>
public class RegistryFrozenEventArgs<T> : EventArgs where T : class
{
    /// <summary>
    /// The registry
    /// </summary>
    ...
    /// </summary>
    /// <param name="registry">The registry</param>
    public RegistryFrozenEventArgs(Registry<T> registry)
    {
        Registry = registry;
    }
}
